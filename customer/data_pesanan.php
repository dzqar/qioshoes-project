	...
	<main>
		...
		foreach ($tampilDaftarPesanan as $d) {
			...
			<table border="0" style="width: 100%;">
				<tr>
					<th colspan="3"><h2>Bukti Pesanan</h2></th>
				</tr>
				<tr>
