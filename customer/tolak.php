...
<body>
	...
	<!-- <form action="proses.php" method="GET">
		...
		<button class="btn btn-primary" type="submit" value="batalPesanan" name="btn">Batalkan Pesanan</button>
	</form> -->
	<section>
		<div class="container-fluid mb-3">
			<form action="proses.php" method="POST" onsubmit="return confirm('Apakah anda yakin ingin membatalkan pesanan?')">
				<?php foreach($tampilDaftarPesanan as $d){ ?>
					<!-- <input type="number" name="id_sepatu" value="<?= $d['id_sepatu']?>"> -->
					...
					<div class="container">
						...
						<!-- Alasan Batal -->
						<div class="row justify-content-center">
							<textarea name="alasan" id="" cols="10" rows="3" class="form-control w-50 border border-black" placeholder="Alasan Batal"required></textarea>
						</div>
						...
						<div class="row justify-content-center">
							<div class="col text-end">
								...
								<button type="submit" value="batalPesanan" name="btn" class="rounded-4 btn text-wrap" style="
								--bs-btn-color: #fff;
								--bs-btn-bg: #3e3232;
								--bs-btn-hover-color: black;
								--bs-btn-hover-bg: #fff;
