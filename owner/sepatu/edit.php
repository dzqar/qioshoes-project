			...
			<form action="proses.php" enctype="multipart/form-data" method="POST">
				...
				<div class="container">
					...
					<div class="row justify-content-center mb-3">
						...
						<div class="col-4"><input type="text" name="nama_sepatu" class="form-control-lg border border-black" value="<?= $d['nama_sepatu']?>"></div>
					</div>

					<!-- Deskripsi -->
					<div class="row justify-content-center">
						<textarea name="deskripsi" cols="20" rows="2" class="form-control w-50 border border-black"><?= $d['deskripsi']?></textarea>
					</div>
					...
					<div class="row justify-content-center">
						<div class="col text-end">
							...
							<button type="submit" value="EditSepatu" name="btn" class="rounded-4 btn text-wrap" style="
							--bs-btn-color: #fff;
							--bs-btn-bg: #3e3232;
							--bs-btn-hover-color: black;
							--bs-btn-hover-bg: #fff;
